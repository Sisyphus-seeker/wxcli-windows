...
pub async fn cmd_serve(
    ...
    let direct_mode = acct.raw_key.is_some() && wx_context::direct_encrypted_open_available();
    ...
    // Signal handler: cancel the shutdown token on the platform shutdown signal.
